...
export default function Investors() {
  return (
    <>
      <Header />
      <VStack pt={{ base: 0, md: 6 }} pb={{ base: 12, md: 24 }} w="100vw" h="max-content" spacing={{ base: 8, md: 16 }}>
        <VStack w={{ base: '100%', md: '80%', lg: '50%' }} spacing={{ base: 2, md: 4 }} px={{ base: 10, md: 0 }}>
          <Heading w={{ base: '85%', lg: '80%' }} pl={{ md: 12, lg: 16 }} as="h2">Industry Perspective</Heading>
          <Heading as="h1" fontSize={{ base: '46px', md: '64px' }}>Investors</Heading>
          <Text w={{ base: '85%', md: '80%' }} color="#656565" pt={{ base: 4, md: 8 }} textAlign="justify">
        ...
        <VStack w={{ base: '100%', md: '85%', lg: '60%' }} spacing={{ base: 4, md: 8 }} display="flex" px={{ base: 10, md: 0 }}>
          ...
          <VStack pt={{ base: 0, md: 2 }} spacing={0} w="100%">
            <Text alignSelf="start">
              E: <Link as={NextLink} href="mailto:johara@cybeck.com" fontSize={{ base: '18px', md: '20px' }}>johara@cybeck.com</Link>
            </Text>
